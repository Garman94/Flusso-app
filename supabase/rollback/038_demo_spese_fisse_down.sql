-- Rollback della migration 038: rimette la reseed_demo() della 037 e ricarica i dati demo.
-- La funzione della 037 svuota già budget e voci ricorrenti della demo, quindi basta questo.
-- Tocca solo i dati dell'utente demo@flussoapp.it.
-- Uso, solo se serve tornare indietro:
--   npx --no-install supabase db query --linked -f supabase/rollback/038_demo_spese_fisse_down.sql
